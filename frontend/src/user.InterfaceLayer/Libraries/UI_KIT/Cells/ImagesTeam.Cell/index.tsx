...
const ReportBlock: React.FC<ReportBlockProps> = (props) => {
  ...
  return (
    <div
      className={`${className} flex flex-col rounded-[20px] pt-4 pr-3 pb-3 pl-4 gap-[5px] w-[162px]`}
    >
      ...
      <div className="flex justify-end">
        <ImageAtom
          ...
          icon={icon}
          className="py-[11px] px-[12px] rounded-[12px] w-[40px] h-[40px] bg-bg_white [&>svg]:w-[18px] [&>svg]:h-[20px] [&>svg]:stroke-bg_tertiary"
        />
      </div>
    </div>
  );
