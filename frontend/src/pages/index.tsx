        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-5 mt-5 ml-8">
            ...
            >
              <div className="flex flex-col gap-3 max-w-[322px] text-text_secondary">
                ...
                <TextAtom type={TextAtomEnum.enum_h4}>
                  До конца года у вас есть уникальная возможность
                  воспользоваться нашей новогодней скидкой 20% на любой курс!
                </TextAtom>
              </div>
            ...
            >
              ...
              <ButtonAtom type={ButtonAtomEnum.enum_textButton}>
                Button
              </ButtonAtom>
            </div>
